...
export default async function userHandler(
  ...
  switch (method) {
    case 'GET':
      ...
      console.log(
        `GET /api/speakers/${id} status: 200`,
      );
    ...
    case 'PUT':
      try {
        ...
        console.log(
          `PUT /api/speakers/${id} status: 200`,
        );
      } catch (e) {
        console.log(
          '/api/speakers PUT error:',
          e,
        );
      }
      break;
    ...
    case 'POST':
      try {
        ...
        res.status(200).json(recordFromBody);
        console.log(
          `POST /api/speakers/${id} status: 200`,
        );
      } catch (e) {
        console.log(
          '/api/speakers POST error:',
          e,
        );
      }
      break;
    ...
    case 'DELETE':
      try {
        ...
        res.status(200).json(recordFromBody);
        console.log(
          `DELETE /api/speakers/${id} status: 200`,
        );
      } catch (e) {
        console.log(
          '/api/speakers DELETE error:',
          e,
        );
      }
      break;
