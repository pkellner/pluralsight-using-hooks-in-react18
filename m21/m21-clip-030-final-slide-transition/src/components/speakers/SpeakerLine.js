...
const SpeakerLine = memo(({ speakerRec, toggleFavoriteSpeaker, updating, highlight }) => {
            ...
            <div className="flex-grow-1 ms-3 me-5">
              <div className="list-group">
                <div className="d-flex w-100 justify-content-between">
                  <h5 className={highlight === true ? "mb-1 background-text-highlight" : "mb-1"}>
                    {speakerRec.firstName} {speakerRec.lastName}
                  </h5>
                  <div className="spinner-bottom">
                    <FavoriteSpeakerToggleLine speakerRec={speakerRec} toggleFavoriteSpeaker={toggleFavoriteSpeaker}>
