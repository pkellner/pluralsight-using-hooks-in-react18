...
export default function SpeakerDetailContent(props) {
        ...
        <div className="card-body p-5">
          <div className="speaker-content-wrapper">
            <h2 className="card-title mb-4">
              <SpeakerName speaker={props.currentSpeaker} />
            </h2>

            <div className="speaker-bio-section mb-4">
              <h5 className="text-muted mb-3">Biography</h5>
              <p className="card-text lh-lg">{props.currentSpeaker.bio}</p>
            </div>
            ...
            <div className="speaker-meta-section">
              <div className="row mb-4">
                <div className="col-lg-6 mb-3">
                  ...
                  <p className="mb-0 fw-medium">
                    <SpeakerCompany speaker={props.currentSpeaker} />
                  </p>
                </div>
              </div>

              {props.currentSpeaker.email && (
                <div className="mb-4">
              ...
              <div className="d-flex gap-4">
                {props.currentSpeaker.sun && props.currentSpeaker.sat && (
